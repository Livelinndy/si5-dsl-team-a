...
def scenario1():
        actions = [AppInit(),
                   ...
                   AddText('c2', 'thanks for watching', '15s', start_at = '1m55s'),
...
def demoVideo():
        actions = [AppInit(),
                   ...
                   Video('c1b', 'frogs.mp4', '1m33s', '1m45s'),
                   Video('c1c', 'frogs.mp4', '2m03s', '2m10s'),
                   AddText('c1a', 'Wow, what a nice frog', pos_y = 'bottom'),
                   AddText('c1c', 'Wow, what a nice frog', pos_y = 'bottom'),
